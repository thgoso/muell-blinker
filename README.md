...
| 391     | Schlafenszeit Täglich Stunde | PACKED BCD |
| 392     | Schlafenszeit Täglich Minute | PACKED BCD |
| 393     | Tag Zeitumstellung März      | PACKED BCD |
| 394     | Tag Zeitumstellung Oktober   | PACKED BCD |
...
Möglicher Bereich: 03:00 bis 15:00 Uhr.

Jeden Tag zu dieser Uhrzeit weckt die RTC den AVR auf. Dieser steuert ggf. die LEDs an.

**Schlafenszeit Täglich:**

Möglicher Bereich 11:00 bis 23:00 Uhr, natürlich NACH Weckzeit.

Jeden Tag zu dieser Uhrzeit geht der AVR spätestens Schlafen.
...
Schlafenszeit AVR täglich = 21:30

Zeitumstellung MEZ > MESZ = 25. März

Zeitumstellung MESZ > MEZ = 28. Oktober

| Adresse Dezimal  | 384  | 385  | 386  | 387  | 388  | 389  | 390  | 391  | 392  | 393  | 394  |
| ---------------- | ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- |
...
1. AVR wird täglich vom DS3231 zur Weckzeit geweckt.
   - Falls LED-Daten zum Datum hinterlegt
     - LEDs passend zum Datum ansteuern bis:
       - Schlafenszeit erreicht ist oder Nutzer den Taster drückt
...
- LED0 & LED1: Fehler beim Zugriff auf DS3231
  ...
  - DS3231 defekt
- LED2 & LED3: Fehler beim Zugriff auf AT24C32
  - Slave Adresse in config.h falsch
  - AT24C32 defekt
...
sozusagen als Bestätigung "Ich hab die Tonnen rausgebracht".
Bei geschickter Wahl von "Weckzeit" und "Schlafenszeit" des AVR läßt sich somit die Leuchtdauer der LEDs reduzieren.
