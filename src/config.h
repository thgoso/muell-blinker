...
// Variante AT24C32 EEPROM:                       - Daten selber im EEPROM Adresse 0-392 = 393 Bytes speichern
// Variante AVR-Flash oder AVR-EEPROM:            - Hier MY_DATA definieren und die 393 Bytes Daten darin ablegen
